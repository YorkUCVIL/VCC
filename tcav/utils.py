...
def print_results(results, random_counterpart=None, random_concepts=None, num_random_exp=100,
    min_p_val=0.05):
  """Helper function to organize results_summaries.
  ...
  Args:
    results: dictionary of results_summaries from TCAV runs.
...
# def results_to_proto(results_summaries):
#   """Given a list of result dicts, convert it to a tcav.Results proto.
#
#   Args:
#     results_summaries: a list of dictionaries returned by tcav.run()
#
#   Returns:
#     TCAV.Results proto
#   """
#   results_proto = Results()
#   for result in results_summaries:
#     results_proto.results_summaries.append(result_to_proto(result))
